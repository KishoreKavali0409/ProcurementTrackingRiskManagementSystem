...
export const STATUSES: CaseStatus[] = [
  'Draft', 'Under Review', 'Sourcing', 'Negotiation', 'Approved', 'Closed', 'Cancelled',
];
...
export const SAMPLE_CASES: ProcurementCase[] = [
  {
    ...
    assignedTo: 'Priya Sharma', priority: 'Critical', status: 'Negotiation',
  ...
  },
  {
    ...
    assignedTo: 'Rajan Pillai', priority: 'High', status: 'Sourcing',
  ...
  },
  {
    ...
    assignedTo: 'Priya Sharma', priority: 'Critical', status: 'Approved',
  ...
  },
  {
    ...
    assignedTo: 'Anand Kumar', priority: 'High', status: 'Under Review',
  ...
  },
  {
    ...
    assignedTo: 'Rajan Pillai', priority: 'Low', status: 'Closed',
  ...
  },
  {
    ...
    assignedTo: 'Anand Kumar', priority: 'Medium', status: 'Draft',
  ...
  },
  {
    ...
    assignedTo: 'Anand Kumar', priority: 'Medium', status: 'Sourcing',
